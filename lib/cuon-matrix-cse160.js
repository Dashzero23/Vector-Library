...
class Vector3 {
    ...
    add(other) {
        ...
        var curVector = this.elements;
        var othVector = other.elements;

        curVector[0] += othVector[0];
        curVector[1] += othVector[1];
        curVector[2] += othVector[2];
    ...
    magnitude() {
        ...
        let curVector = this.elements;
        m = Math.sqrt(curVector[0] * curVector[0] + curVector[1] * curVector[1] + curVector[2] * curVector[2]);
        // Don't delete the return statement.
        return m;
    };
    ...
    normalize() {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        let mag = this.magnitude(); // Get magnitude
        if (mag !== 0) {
            let curVector = this.elements;
            curVector[0] /= mag;
            curVector[1] /= mag;
